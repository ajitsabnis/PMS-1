...
angular.module('pmsApp')
  .controller('patientMasterCtrl', ['$scope', 'patientMaster', '$rootScope', 'localStorageService', '$location', 
    function ($scope, patientMaster, $rootScope, localStorageService, $location) {
